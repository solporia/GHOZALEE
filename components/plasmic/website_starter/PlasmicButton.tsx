...
// Plasmic Project: 2MhtxvRo5REQHn1Tdr3eTd
// Component: ChY5yskcrU9C
...
import projectcss from "./plasmic.module.css"; // plasmic-import: 2MhtxvRo5REQHn1Tdr3eTd/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: ChY5yskcrU9C/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: zaISpoVo168p/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: gXGRwpYG0XHz/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__lyTsX)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___7XEq)}
                role={"img"}
              />
            ),
